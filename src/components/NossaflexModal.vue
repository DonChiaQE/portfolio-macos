...
<template>
    <div class="flex-container" id="flex-container">
        <div class="about-me" id="container" ref="draggableContainer" :class="{ fullscreen: $store.getters.isFullscreenNossaflex, close: !$store.getters.isShownNossaflex}">
            <div class="top-bar" id="top-bar" v-on:dblclick="$store.commit('toggleFullscreenNossaflex')" @mousedown="dragMouseDown">
